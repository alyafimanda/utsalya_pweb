...
<template>
  <div class="text-center">
    ...
    <input v-model="cari" class="form-control me-2" type="search" placeholder="Masukkan Nomor Surat" aria-label="Search">
    <div class="mt-5">
    ...
    <div v-for="(ayat,t) in surat" :key="t" class="card">
      <div class="card-body">
      <h5 class="card-title text-end">{{ ayat.text_uthmani }} {{ayat.verse_key}}</h5>
      <p class="card-text text-center">Terjemahan :</p>
      <p class="card-text text-center" v-html="translations[t].text"></p>
    </div>
    </div>
